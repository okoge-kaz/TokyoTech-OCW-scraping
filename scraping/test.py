...
def main():
    ...
    # print(value)
    data.extend(get_major_all_course_list(
        '英語科目', 'http://www.ocw.titech.ac.jp/index.php?module=Archive&action=ArchiveIndex&GakubuCD=7&KamokuCD=110200&tab=2&focus=100&lang=JA&Nendo=2020&SubAction=T0210'))
    print(data)
